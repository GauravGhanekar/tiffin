...
public class MessRegistration extends AppCompatActivity {
    ...
    String fName, lName, emailId, password, comPassword, mobile, house, area2, pinCode2, role="mess",state, city;
    boolean isValid;
        ...
        Statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(state.equals("Maharashtra")){
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(MessRegistration.this, android.R.layout.simple_spinner_item,list);
